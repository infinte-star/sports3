...
public class FavoriteFragment extends Fragment {
    ...
    private String imageUrl = "http://www.hn.chinanews.com/hnphoto/pages/U407P9T204D24895F3265DT20151012095639.jpg";
...
//        Glide.with(getContext()).load(imageUri).into(jcVideoPlayerStandard.thumbImageView);
    ...
    private List<Map<String, Object>> DataList() {
        ...
        map.put("author_photo", R.drawable.sun);
        map.put("author_name", "Sun Shou");
        map.put("coach_introduction", "champion coach");
        list.add(map);

        map = new HashMap<String, Object>();
        map.put("author_photo", R.drawable.zhou);
        map.put("author_name", "Zhou Kun");
